...
There are various ways to collect tweet-related data; we propose here to use [Communalytic](https://communalytic.org/) (formerly Netlytic), an online tool that does not require specific skills in programming. For this tutorial, you need to have a Communalytic account. Note that, if you wish to collect data from other platforms connected to Communalytic (YouTube, Telegram and Reddit), you will have to open an account on those platforms. For X, you will also need to pay a subscription.  
...
## Setting the scene: what is the BlueSky API and how does it work? <a id="section2"></a>
