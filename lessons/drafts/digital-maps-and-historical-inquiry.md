...
*Learning outcome: hands-on experience to understand map projection and its effect on the visualisation of space*
...
### 2.c Elucidating choices, audience and purpose: imagining populations in maps
By Peter Haslinger
...
## 3 History in action: Maps as (real-time) data
...
*Learning outcome - – understand how the availability of digital data, the internet and communities can impact, democratise and shine a light on the production and communication of maps* 
...
All the different map examples you have studied above show how varied the design of maps can be, despite the general consensus on what elements most maps should include. We have also learned that the primary goal of mapping is to pass on information: users should get a spatial sense and understanding of the data, as well as engaging with a specific story.
