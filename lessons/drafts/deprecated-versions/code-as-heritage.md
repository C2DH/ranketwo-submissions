...
> **This was the initial file of the lesson; it was updated by the author but also a new file was created in this occasion, named v2. In order to avoid conflicting versions and multiple files, the v2 created by the author is now the working version and renamed with the lesson slug, and is located in the folder of the active drafts. This file will be held here as long as the lesson is in progress in this repository and will be removed after publication. Note of Febr. 2026.**
...
The following two documents illuminate how digital heritage recognition has evolved over time and the challenges faced by preservation efforts. These readings provide essential historical context and current thinking around source code preservation.
...
Abelson, Harold, and Gerald Jay Sussman. 1996. Structure and Interpretation of Computer Programs. The MIT Press. https://sarabander.github.io/sicp/html/index.xhtml
...
**The Inheritance of Source Criticism**

Historians trained in source criticism will recognize familiar questions when approaching code: Who created this? When? For what purpose? Has it been altered? Can we trust it? These questions remain essential. Traditional source criticism distinguishes between:

* **External criticism:** establishing authenticity, provenance, dating, transmission
* **Internal criticism:** interpreting content, meaning, context

**The Entanglement Problem**

In born-digital sources, this distinction becomes complicated. Code often contains its own metadata—the artifact documents itself. Comments embed provenance information. Version histories record transmission. Cultural references sit alongside technical instructions. The boundary between document and documentation collapses.

This is not a failure of method but a characteristic of digital heritage requiring adapted approaches. As scholars of digital historiography have argued, born-digital sources possess different material properties than traditional documents: reproducibility without degradation, dependency on technical infrastructure, and the embedding of multiple temporalities within single artifacts ([Fickers 2012](https://jethc.eu/index.php/jethc/article/view/jethc015); [Kirschenbaum 2008](https://mitpress.mit.edu/9780262517409/mechanisms/)).

**The Layered Reading Approach**

Rather than applying external and internal criticism sequentially, we propose a **layered reading** that holds multiple dimensions simultaneously:

1. **Code as technical object** – what it does, how it functions
2. **Code as textual artifact** – what it says, how it communicates
3. **Code as historical trace** – what contexts it embeds
4. **Code as archival construction** – how it reached us, what interventions shaped it

These layers are concurrent, not sequential. A single element—a function name, a comment, a formatting choice—may speak to all four dimensions at once. As Mark Marino argues in *Critical Code Studies* (2020), we must attend to "the extra-functional significance of computer source code"—what code means beyond what it does.
...
When approaching any code artifact, consider the following dimensions:
...
**Question the broader context.** When and why was this code written? In what environment? What problem did it address? What technological constraints existed? Can you create a technological genealogy? You can then deepen the provenance and authenticity aspect from further analysis.

**Dependencies and Networks:** You should examine what external code a program relies on as it reveals networks of collaboration and influence. Like citations in academic papers, dependencies show how programmers built upon existing work and participated in broader development communities. For example, the Internet is so dependent on Open Source code that in 2016 a single developer was capable of breaking the Internet for several minutes by suppressing 11 lines of code ([Collins 2016](https://qz.com/646467/how-one-programmer-broke-the-internet-by-deleting-a-tiny-piece-of-code)).
...
We now apply the layered reading approach to a specific code artifact. Examine this snippet:
