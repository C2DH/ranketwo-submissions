...
Choose the type of interaction you want to examine and click on “Analyze”. You will first obtain the number of Twitter accounts who are tied by retweets or tied in self-loops. A self-loop represents a user (a Twitter account) that only tweets, so not in fact a retweet. Next click on “Visualize” and a pop-out will appear of a retweet network visualisation.
