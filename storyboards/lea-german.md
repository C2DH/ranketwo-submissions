...
Szene 3: Technische Herausforderungen 
...
Szene 4: Katalogisierung der Fundstücke (Lea nimmt ihre Stimme mit ihrem Smartphone auf und beschreibt jedes Objekt sorgfältig laut.)

Lea: Autor, Titel (beschreibt ein Buch) … Absender, Empfänger (beschreibt eine Postkarte) … Datum, Ort (beschreibt ein Foto) … jedes Detail zählt!

(Lea nimmt Kassetten in die Hand und untersucht die Aufkleber.)

Lea: Auf den Aufklebern dieser Kassetten steht … „Familientreffen, Weihnachten '83“. Zu erledigen: Kassettenrekorder finden, anhören, Inhalt beschreiben, digitalisieren …

________________



Szene 5: Analyse von Disketten (mit Ada) (Lea und Ada arbeiten gemeinsam bei Ada zu Hause. Ada untersucht eine Diskette.)

Ada: Schlechte Nachrichten – das Dateiformat ist veraltet. Gute Nachrichten – wir können die Metadaten noch lesen.

Lea: Metadaten?

Ada: Ja! Dateigröße, Erstellungsdatum, Dateityp – immer noch wertvolle Hinweise!
...
Schlussszene: (Der Bildschirm blendet zur Website des Projekts mit den Fotos der Großmutter über.)
Lea (Stimme aus dem Off): Bei der Bewahrung von Erinnerungen geht es nicht nur darum, die Vergangenheit lebendig zu halten. Es geht darum, sie mit Bedacht zu teilen, die Privatsphäre zu respektieren und sicherzustellen, dass unser digitales Erbe ethisch genutzt wird.
